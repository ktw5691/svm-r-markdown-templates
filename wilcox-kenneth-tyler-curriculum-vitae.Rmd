...
\hangindent = 2em \hangafter = 1 **Wilcox, K. T.**, Ammerman, B. A., Jacobucci, R., Dixon-Gordon, K., Waite, E. E., & McCloskey, M. S. (In press). A text mining approach to characterizing interpersonal stress among individuals with a nonsuicidal self-injury history. *Current Psychology*.
