...
(Accepted). Visual perception in bottlenose dolphins: Successful recognition of
2D objects rotated in the picture and depth planes. *Journal of Comparative
Psychology*.

\hangindent = 2em
\hangafter = 1
**Wilcox, K. T.**, Jacobucci, R., & Zhang, Z. (Accepted). Bayesian supervised topic
modeling with covariates. *Multivariate Behavioral Research* (Abstract).
...
Morrison, E. K., DeLong, C. M., & **Wilcox, K. T.**. Humans discriminate among
bottlenose dolphin signature whistles masked by noise: Investigating perceptual
strategies for anthropogenic noise pollution. Manuscript in preparation.
