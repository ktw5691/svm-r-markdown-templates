...
training. *Behavioural Processes*, 141, 172-183. doi:10.1016/j.beproc.2016.11.011
...
\hangindent = 2em
\hangafter = 1
DeLong, C. M.,Fobe, I., O’Leary, T., & **Kenneth Tyler Wilcox**.
Visual perception of rotated 2D objects in goldfish (*Carassius auratus*).
Manuscript under review.

\hangindent = 2em
\hangafter = 1
DeLong, C. M., Keller, A., **Wilcox, K. T.**, & Keenan, S. Visual discrimination
for geometric and complex 2D shapes in goldfish (*Carassius auratus*).
Revise and resubmit.
...
DeLong, C. M., Wright, C., Fobe, I., **Wilcox, K. T.**, & Morrison, E. North
American river otters (*Lontra canadensis*) discriminate between 2D objects
varying in shape and color. Manuscript in preparation.
...
linguistic structure. Paper accepted for presentation at the 2018 International
Meeting of the Psychometric Society, New York City, New York.
