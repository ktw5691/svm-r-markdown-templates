...
\hangindent = 2em
\hangafter = 1
**Wilcox, K. T.**, Jacobucci, R., & Zhang, Z. Bayesian supervised topic
...
\hangindent = 2em
\hangafter = 1
Ammerman, B. A., **Wilcox, K. T.**, O'Loughlin, C. M., & McCloskey, M. S.
Characterizing the choice to disclose nonsuicidal self-injury. Manuscript in
preparation.
...
\hangindent = 2em
\hangafter = 1
DeLong, C. M., Morrison, E., Wegman, J., Morelli, J., Rachfal, T.,
& **Wilcox, K. T.**. Visual object categorization in goldfish
(*Carassius auratus*). Poster submitted for presentation at the 27th Annual
