...
Ammerman, B. A. (in press). Supervised latent Dirichlet allocation with
covariates: A Bayesian structural and measurement model of text and covariates.
*Psychological Methods*. <https://doi.org/10.1037/met0000541>
...
modeling framework for item response and topic models. [Manuscript submitted for publication]. Department of Psychology, University of Notre Dame. <https://doi.org/10.31219/osf.io/fzx7r>

\hangindent = 2em \hangafter = 1 Schor, D., **Wilcox, K. T.**, & Gibson, B. S. (2022). Partial recall: Evidence for the discrete slot limit of working memory capacity. [Manuscript submitted for publication]. Department of Psychology, University of Notre Dame.
...
\hangindent = 2em \hangafter = 1 Ong, A. D., **Wilcox, K.T.**, Moskowitz, J. T., Wethington, E., & Reid, M. C. *Feasibility, acceptability, and preliminary efficacy of a positive affect skills intervention for adults with fibromyalgia*. [Manuscript in preparation]. Department of Psychology, Cornell University.
...
## [Journal Manuscript Review](https://www.webofscience.com/wos/author/rid/AAK-8872-2020)
