...
**Teaching Assistant**, Department of Psychology \hfill
08/2019--12/2019

\hangindent = 2em
\hangafter = -2
Courses: Quantitative Methods I (graduate course)
...
modeling: Why, how, and when. Manuscript submitted for publication.

\hangindent = 2em
\hangafter = 1
DeLong, C. M., Fellner, W., **Wilcox, K. T.**, Odell, K., & Harley, H. E. Visual
perception in bottlenose dolphins: Successful recognition of 2D objects rotated
in the picture and depth planes. Manuscript submitted for publication.
...
\hangindent = 2em
\hangafter = 1
Jacobucci, R., Ammerman, B., & **Wilcox, K. T.** The application of machine
learning for text-based responses to improve suicide risk prediction.
*Suicide and Life Threatening Behavior*. Manuscript in preparation; invited for
special issue.
...
\hangindent = 2em
\hangafter = 1
**Wilcox, K. T.** (2019). Psychtm: Text mining for psychological research
(Version 2019.7) [Computer software]. Available at
...
\hangindent = 2em
\hangafter = 1
**Wilcox, K. T.** (2019, October). Bayesian supervised topic modeling with covariates. Poster submitted for presentation at the 17th Annual Society of Multivariate Experimental Psychology Graduate Student Conference, Baltimore, Maryland.
...
mining to predict nonsuicidal self-injury. Paper accepted for presentation at
the 53rd Annual Convention for the Association for Behavioral and Cognitive
Therapies, Atlanta, Georgia.
...
ideation. Paper accepted for presentation at the 53rd Annual Convention for the
Association for Behavioral and Cognitive Therapies, Atlanta, Georgia.
